...
public class EmailBot extends javax.mail.Authenticator {
    ...
    public synchronized boolean sendScanReport(String to, Place p, Context context){
        ...
        send(String.format("Wifi scan report of %s", p.getPlace_name()), message, to);
        return true;
    }
